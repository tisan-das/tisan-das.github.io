...
image: /images/gfs/vmwareFT_protocol.webp
...
![Output Rule: vmware FT protocol](/images/gfs/vmwareFT_protocol.webp){: .light }
![Output Rule: vmware FT protocol](/images/gfs/vmwareFT_protocol-dark.webp){: .dark }
_Output Rule: vmware FT protocol_
...
![Logging Channel: vmware FT architecture](/images/gfs/vmwareFT_architecture.webp){: .light }
![Logging Channel: vmware FT architecture](/images/gfs/vmwareFT_architecture-dark.webp){: .dark }
_Logging Channel: vmware FT architecture_
