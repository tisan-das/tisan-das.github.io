...
image: /images/asynchronous-intro/pointToPoint_oneWayMessaging.png
...
![Messaging Channels: point To Point one Way Messaging](/images/asynchronous-intro/pointToPoint_oneWayMessaging.png){: .light }
![Messaging Channels: point To Point one Way Messaging](/images/asynchronous-intro/pointToPoint_oneWayMessaging-dark.png){: .dark }
_Messaging Channels: point To Point one Way Messaging_
![Messaging Channels: point To Point request Response Messaging](/images/asynchronous-intro/pointToPoint_requestResponseMessaging.png){: .light }
![Messaging Channels: point To Point request Response Messaging](/images/asynchronous-intro/pointToPoint_requestResponseMessaging-dark.png){: .dark }
...
![Messaging Channels: publish Subscribe one Way Messaging](/images/asynchronous-intro/publishSubscribe_oneWayMessaging.png){: .light }
![Messaging Channels: publish Subscribe one Way Messaging](/images/asynchronous-intro/publishSubscribe_oneWayMessaging-dark.png){: .dark }
_Messaging Channels: publish Subscribe one Way Messaging_
![Messaging Channels: publish Subscribe request Response Messaging](/images/asynchronous-intro/publishSubscribe_requestResponseMessaging.png){: .light }
![Messaging Channels: publish Subscribe request Response Messaging](/images/asynchronous-intro/publishSubscribe_requestResponseMessaging-dark.png){: .dark }
