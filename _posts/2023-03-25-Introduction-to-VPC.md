...
![VPC Basics: VPC Settings dns Hostname](/images/vpc-intro/vpcSettings_dnsHostname.png)
...
![Subnet & Router Association: subnet Settings](/images/vpc-intro/subnetSettings.png)
...
![Subnet & Router Association: route Table](/images/vpc-intro/routeTable.png)
...
![Internet Gateway vs NAT Gateway: internet Gateway](/images/vpc-intro/internetGateway.png)
![Internet Gateway vs NAT Gateway: ig Route Entry](/images/vpc-intro/igRouteEntry.png)
...
![Internet Gateway vs NAT Gateway: nat Gateway](/images/vpc-intro/natGateway.png)
...
![Traffic Privacy: sec Group](/images/vpc-intro/secGroup.png)
...
![Traffic Privacy: nacl](/images/vpc-intro/nacl.png)

### Overall security at VPC:
![Overall security at VPC: security](/images/vpc-intro/security.png)
...
![VPC Peering: peering Routing](/images/vpc-intro/peeringRouting.png)
...
![Three-Tier Architecture: 3Tier Architecture](/images/vpc-intro/3TierArchitecture.png)
