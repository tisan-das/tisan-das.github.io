...
![Network traffic](/images/consul-overview/network_traffic.png)
...
![Consul Architecture: overview](/images/consul-overview/overview.svg)
...
![Consul agents: replication](/images/consul-overview/replication.svg)
...
![LAN gossip pool: gossip Pool](/images/consul-overview/gossipPool.svg)
...
![Zero trust network policy: sidecar Proxy](/images/consul-overview/sidecarProxy.png)
