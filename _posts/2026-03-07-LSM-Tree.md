...
math: true
image: /images/sys-design-fundamentals/04-storage-internal/01-lsm-intro.webp
categories: ["Databases", "Internals"]
tags: [lsm-tree, storage-engines]
published: true
---
...
![Building blocks: LSM intro](/images/sys-design-fundamentals/04-storage-internal/01-lsm-intro.webp){: .light }
![Building blocks: LSM intro](/images/sys-design-fundamentals/04-storage-internal/01-lsm-intro-dark.webp){: .dark }
_Building blocks: LSM intro_
...
![SSTables (Sorted String Tables): LSM sstable](/images/sys-design-fundamentals/04-storage-internal/02-lsm-sstable.webp){: .light }
![SSTables (Sorted String Tables): LSM sstable](/images/sys-design-fundamentals/04-storage-internal/02-lsm-sstable-dark.webp){: .dark }
_SSTables (Sorted String Tables): LSM sstable_

##### Compaction

There can be multiple L0 files that are not sorted; hence, compaction happens differently in L0 than in the other levels.

![Compaction: LSM l0 compaction](/images/sys-design-fundamentals/04-storage-internal/03-lsm-l0-compaction.webp){: .light }
![Compaction: LSM l0 compaction](/images/sys-design-fundamentals/04-storage-internal/03-lsm-l0-compaction-dark.webp){: .dark }
_Compaction: LSM l0 compaction_

![Compaction: LSM ln compaction](/images/sys-design-fundamentals/04-storage-internal/03-lsm-ln-compaction.webp){: .light }
![Compaction: LSM ln compaction](/images/sys-design-fundamentals/04-storage-internal/03-lsm-ln-compaction-dark.webp){: .dark }
_Compaction: LSM ln compaction_
