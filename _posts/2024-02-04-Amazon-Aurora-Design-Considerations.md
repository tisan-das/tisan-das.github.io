...
image: /images/aurora/locallyReplicated.png
...
![History of DB on AWS: locally Replicated](/images/aurora/locallyReplicated.png){: .light }
![History of DB on AWS: locally Replicated](/images/aurora/locallyReplicated-dark.png){: .dark }
...
![History of DB on AWS: cross Region Replicated](/images/aurora/crossRegionReplicated.png){: .light }
![History of DB on AWS: cross Region Replicated](/images/aurora/crossRegionReplicated-dark.png){: .dark }
...
![History of DB on AWS: architecture](/images/aurora/architecture.png){: .light }
![History of DB on AWS: architecture](/images/aurora/architecture-dark.png){: .dark }
...
![Consistency: enhanced Architecture](/images/aurora/enhancedArchitecture.png){: .light }
![Consistency: enhanced Architecture](/images/aurora/enhancedArchitecture-dark.png){: .dark }
