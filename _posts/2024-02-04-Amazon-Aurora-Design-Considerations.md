...
image: /images/aurora/locallyReplicated.webp
...
![History of DB on AWS: locally Replicated](/images/aurora/locallyReplicated.webp){: .light }
![History of DB on AWS: locally Replicated](/images/aurora/locallyReplicated-dark.webp){: .dark }
_History of DB on AWS: locally Replicated_
...
![History of DB on AWS: cross Region Replicated](/images/aurora/crossRegionReplicated.webp){: .light }
![History of DB on AWS: cross Region Replicated](/images/aurora/crossRegionReplicated-dark.webp){: .dark }
_History of DB on AWS: cross Region Replicated_
...
![History of DB on AWS: architecture](/images/aurora/architecture.webp){: .light }
![History of DB on AWS: architecture](/images/aurora/architecture-dark.webp){: .dark }
_History of DB on AWS: architecture_
...
![Consistency: enhanced Architecture](/images/aurora/enhancedArchitecture.webp){: .light }
![Consistency: enhanced Architecture](/images/aurora/enhancedArchitecture-dark.webp){: .dark }
_Consistency: enhanced Architecture_
