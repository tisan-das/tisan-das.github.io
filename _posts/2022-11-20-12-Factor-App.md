...
published: true
title: 12-Factor App
image: /images/12-Factor-App/12FactorAuth_buildReleaseRun.webp
categories: ["Cloud & DevOps", "Fundamentals"]
...
![Build, release, run](/images/12-Factor-App/12FactorAuth_buildReleaseRun.webp){: .light }
![Build, release, run](/images/12-Factor-App/12FactorAuth_buildReleaseRun-dark.webp){: .dark }
_Build, release, run_
